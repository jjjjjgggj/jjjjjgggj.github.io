...
def resize_multiple(img, sizes=(28, 112), resample=Image.BICUBIC, lmdb_save=False): #Image.BICUBIC双三次插值
...
def prepare(img_path, out_path, n_worker, sizes=(28, 112), resample=Image.BICUBIC, lmdb_save=False):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', '-p', type=str,
                        default='/Bigdata/jgj/lwtdm+sr/Dataset/total data train')
    parser.add_argument('--out', '-o', type=str,
                        default='/Bigdata/jgj/lwtdm+sr/Dataset/total data train')

    parser.add_argument('--size', type=str, default='28,112')
